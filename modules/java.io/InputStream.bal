...
public distinct class InputStream {
    ...
    *javalang:Object;
    ...
    # The function that maps to the `skipNBytes` method of `java.io.InputStream`.
    #
    # + arg0 - The `int` value required to map with the Java method parameter.
    # + return - The `IOException` value returning from the Java mapping.
    public function skipNBytes(int arg0) returns IOException? {
        error|() externalObj = java_io_InputStream_skipNBytes(self.jObj, arg0);
        if (externalObj is error) {
            IOException e = error IOException(IOEXCEPTION, externalObj, message = externalObj.message());
            return e;
        }
...
function java_io_InputStream_skipNBytes(handle receiver, int arg0) returns error? = @java:Method {
    name: "skipNBytes",
    'class: "java.io.InputStream",
    paramTypes: ["long"]
} external;
