...
public distinct class FilterInputStream {
    ...
    *InputStream;
    ...
    # The function that maps to the `skipNBytes` method of `java.io.FilterInputStream`.
    #
    # + arg0 - The `int` value required to map with the Java method parameter.
    # + return - The `IOException` value returning from the Java mapping.
    public function skipNBytes(int arg0) returns IOException? {
        error|() externalObj = java_io_FilterInputStream_skipNBytes(self.jObj, arg0);
        if (externalObj is error) {
            IOException e = error IOException(IOEXCEPTION, externalObj, message = externalObj.message());
            return e;
        }
...
function java_io_FilterInputStream_skipNBytes(handle receiver, int arg0) returns error? = @java:Method {
    name: "skipNBytes",
    'class: "java.io.FilterInputStream",
    paramTypes: ["long"]
} external;
